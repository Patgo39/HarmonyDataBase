...
int Rola::getIdRola() const {
    return id_rola;
}

int Rola::getIdPerformer() const {
    return id_performer;
}

int Rola::getIdAlbum() const {
    return id_album;
}

std::string Rola::getPath() const {
    return path;
}

std::string Rola::getTitle() const {
    return title;
}

int Rola::getTrack() const {
    return track;
}

int Rola::getYear() const {
    return year;
}

std::string Rola::getGenre() const {
    return genre;
}
